...
const char* ssid = "OFFICE_MGH";  //--> Your wifi name
const char* password = "amanlancar98"; //--> Your wifi password
//----------------------------------------

// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbwHJeDZhzDMklQBbxHGsO0KMGL8AibhK8pgPz8kJ403gsYT_I-v22kYqyFZV2jqvqX7/exec";
